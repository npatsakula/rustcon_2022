...
>>>>>>> 734e8e0 ([+] Functions JIT compilation.)
...
<<<<<<< HEAD
с большой вложенностью, скомпилируем и сравним скорость вычисления с обычными:
=======
...
<<<<<<< HEAD
2. Инструментария по получению производительности отлично укладывается в правило
=======
...
<<<<<<< HEAD
   дозрели до того уровня, когда можно без невыносимой боли и за вменяемые сроки
   использовать их в промышленной разработки не обладая специальными знаниями
=======
